    ...
    <div class="container marketing">
        ...
        <div class="py-5 text-light justify-content-md-center" style="text-align:center ">
            ...
            <div class="row text-start hover01" style="margin-top: 10%">
                <div class="col-6 ">
                    <h3>WOMEN</h3>
                    <div class="banner"> <img class="img-xs  mx-3" src="{{ asset('img/women-home.jpeg') }}"
                            alt="" width="100%" style="border-radius: 35px"></div>
                </div>
                <div class="col-6">
                    <h3>MEN</h3>
            ...
            <div class="row text-start mt-5 hover01">
                <h3 style="left: 20">SPORTY</h3>
                <div class="col-12">
                    <div class="banner">
